...
function MOD:UpdateLocals()
	...
	CHAT_FONT = LSM:Fetch("font", SV.db.font.clean.file);
	CHAT_FONTSIZE = SV.db.font.clean.size or 11;
	CHAT_FONTOUTLINE = SV.db.font.clean.outline;
	TAB_WIDTH = SV.db.SVChat.tabWidth;
	TAB_HEIGHT = SV.db.SVChat.tabHeight;
	TAB_SKINS = SV.db.SVChat.tabStyled;
	TAB_FONT = LSM:Fetch("font", SV.db.font.tab.file);
	TAB_FONTSIZE = SV.db.font.tab.size;
	TAB_FONTOUTLINE = SV.db.font.tab.outline;
