...
local function FriendsFrameStyle()
	...
	LFRQueueFrameListInset:SetStylePanel("Fixed", "Inset")
	FriendsFrameInset:SetStylePanel("Default", "Inset", true, 6)
	...
	FriendsFrameIgnoreScrollFrame:SetStylePanel("Fixed", "Inset")
