...
local function StyleAtlasLoot()
	...
	MOD:ApplyFrameStyle(_G["AtlasLootDefaultFrame"], "Action");
	MOD:ApplyFrameStyle(_G["AtlasLootItemsFrame"], "Button");
	MOD:ApplyFrameStyle(_G["AtlasLootPanel"], "Transparent");
	...
	MOD:ApplyScrollStyle(AtlasLootCompareFrame_ScrollFrameItemFrameScrollBar)
	MOD:ApplyScrollStyle(AtlasLootCompareFrame_WishlistScrollFrameScrollBar)
	...
	if AtlasLootTooltip:GetName() ~= "GameTooltip" then MOD:ApplyTooltipStyle(AtlasLootTooltip) end
end
MOD:SaveAddonStyle("AtlasLoot", StyleAtlasLoot)